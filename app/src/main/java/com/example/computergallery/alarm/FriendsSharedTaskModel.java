...
public class FriendsSharedTaskModel {
    String alarm_id;
    String alarm_title;
    String alarm_time;
    String alarm_state;
    ...
    public FriendsSharedTaskModel(){
        //this constructor is required
    }


    public FriendsSharedTaskModel(String alarm_id, String alarm_title, String alarm_time, String alarm_state, String alarm_manager_id, String user_id, String task_type, String task_owner_id, String task_seen, String task_image) {
