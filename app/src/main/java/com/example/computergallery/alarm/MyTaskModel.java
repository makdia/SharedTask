...
public class MyTaskModel {
    ...
    public MyTaskModel(String alarm_id, String alarm_title, String alarm_time, String alarm_state, String alarm_manager_id, String user_id, String task_type, String task_owner_id, String task_image) {
