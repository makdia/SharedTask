...
public class MyTaskAdapter extends RecyclerView.Adapter<MyTaskAdapter.MyViewHolder>  {
    private ArrayList<MyTaskModel> alarmLists;
    ...
    public MyTaskAdapter(Context context, List<MyTaskModel> alarmLists) {
        this.alarmLists = (ArrayList<MyTaskModel>)alarmLists;
    ...
    public void onBindViewHolder(final MyViewHolder holder, int position) {
        ...
        final MyTaskModel newsModel=alarmLists.get(position);
        ...
        holder.btn_state.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(state[0].equals("On")){
                    ...
                    MyTaskModel alarmModel = new MyTaskModel(newsModel.getId(), newsModel.getTitle(),  reminderDateTime, "Off", newsModel.getAlarmManagerId(), newsModel.getUserId(), newsModel.getTaskType(), newsModel.getTaskOwnerId(), newsModel.getTaskImage());
                    ...
                    DatabaseReference dR = FirebaseDatabase.getInstance().getReference("Task").child(user_id).child(newsModel.getId());
                    MyTaskModel alarmModel = new MyTaskModel(newsModel.getId(), newsModel.getTitle(),  reminderDateTime, "On", newsModel.getAlarmManagerId(),newsModel.getUserId(), newsModel.getTaskType(), newsModel.getTaskOwnerId(), newsModel.getTaskImage());
                    dR.setValue(alarmModel);
        ...
        holder.btn_edit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("save_task", "edit_my_task");
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener, View.OnLongClickListener {
        ...
        ImageView task_img;
        ArrayList<MyTaskModel> alarmLists=new ArrayList<>();
        Context context;

        public MyViewHolder(View itemView, Context context, ArrayList<MyTaskModel> alarmLists) {
            super(itemView);
            this.context=context;
        ...
        public boolean onLongClick(View v) {
            ...
            final MyTaskModel newsModel=this.alarmLists.get(position);
    ...
    public void deleteAlarm(final MyTaskModel item, String alarm_id, String alarm_title, String alarm_time, String state, String alarm_manager_id, String user_id, String task_type, String task_owner_id, String task_image) {
                Calendar cal = Calendar.getInstance();
                SimpleDateFormat format = new SimpleDateFormat(ReminderEditActivity.DATE_TIME_FORMAT);
                try {
